            ...
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-top-bar d-flex">
                        <!-- Left Side start -->
                        <p><span>{{ $allproducts->count() }}</span> Product Found</p>
                        <!-- Left Side End -->
                        ...
                        <form action="">
                            <div class="sidebar-widget mt-8">
                                ...
                                <div class="price-filter">
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" name="min_price" value="{{ $min }}">
                                        </div>
                                        <div class="col-6">
                                            <input type="text" name="max_price" value="{{ $max }}">
                                        </div>
                                    </div>
                                    <input type="submit" class="btn btn-warning mt-2" value="Search"></input>
                                </div>
                            </div>
                        </form>
                        <!-- Sidebar single item -->
                            ...
                            <div class="sidebar-widget-category">
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a href="#"
                                                class="selected m-0">{{ $category->category_name }}<span>({{ App\Models\Product::where('category_id', $category->id)->count() }})</span>
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            <div class="sidebar-widget-list size">
                                <ul>
                                    @foreach ($sizes as $size)
                                        <li><a class="active-2 gray" href="{{ route('product.size', $size->size) }}">
                                                @if ($size->size == 'Large')
                                                    L
                                                @elseif($size->size == 'Extra Large')
                                                    XL
