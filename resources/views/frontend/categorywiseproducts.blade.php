            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shop-top-bar d-flex">
                        <!-- Left Side start -->
                        <p><span>{{ $categorywiseproducts->count() }}</span> Product Found of
                    ...
                    <div class="shop-bottom-area">
                                                    ...
                                                    <div class="col-md-7 col-lg-7 col-xl-8">
                                                        <div class="content-desc-wrap">
                                                            ...
                                                            <div class="box-inner">
                                                                <span class="price">
                                                                    <span
                                                                        class="new">${{ $product->product_price }}</span>
                                                                </span>
                                                                <div class="actions">
                        ...
                        <div class="text-center load-more-items mt-30px0px" data-aos="fade-up">
                            <a href="#" class="m-auto btn btn-lg btn-primary btn-hover-dark"> Load More <i
