        ...
        <div id="wrapper">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            @if (Auth::user()->role == 2)
                                <li>
                                    <a href="{{ route('email_offer') }}">
                                        <i class="fi-command"></i> <span> Email Offer </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Vendor
                                ...
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Banner
                                        </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Category
                                        </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Location
                                        </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('location') }}">Add Locaton</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> Coupon
                                        </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
            ...
            <div class="content-page">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon bg-purple"><i class="mdi mdi-account-plus"></i>
                                            </div>
                                            <p class="notify-details">New user registered.<small
                                                    class="text-muted">7
                                                    days ago</small></p>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="mb-0 text-muted font-13 user-msg">Hi, How are you? What about our
                                                next meeting</p>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="mb-0 text-muted font-13 user-msg">Yeah everything is fine</p>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="mb-0 text-muted font-13 user-msg">Wow that's great</p>
                                        </a>
                ...
                <footer class="text-right footer">
                    2018-{{ Carbon\Carbon::today()->format('Y') }}. © Highdmin. - Coderthemes.com
                </footer>
