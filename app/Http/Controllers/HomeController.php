...
class HomeController extends Controller
{
    ...
    function single_email_offer($id)
    {
        $email = User::find($id)->email;
        Mail::to($email)->send(new EmailOffer());
        return back();
    }
    function multi_email_offer(Request $request)
    {
    ...
    function locationupdate(Request $request)
    {
        ...
        foreach ($request->countries as $country_id) {
            ...
            // echo Country::find($country_id)->status;
        }
    ...
    function markreceived($order_summery_id)
    {
    ...
    function my_order_details($order_summery_id)
    {
    ...
    function reviewrating(Request $request, $order_detail_id)
    {
        Rating::insert([
            'user_id' => auth()->id(),
    ...
    // Invoice Download
    function invoicedownload(Request $request)
    {
        $pdf = PDF::loadView('pdf.invoice');
        return $pdf->stream('invoice.pdf');
    }
    function invoicedownloadexcel(Request $request)
    {
